![](./images/7178691-0d965cf51eb5af9e.png)
...
然后将本项目clone到本地:
``` shell
git clone https://github.com/DansYU/python_for_data_analysis_2nd_chinese_version.git
cd python_for_data_analysis_2nd_chinese_version
```
